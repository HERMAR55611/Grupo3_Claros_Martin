...
```bash
# Clonar repositorio
git clone https://github.com/HERMAR55611/Grupo3_Claros_Martin.git
cd etl-weatherstack
...
Juan Jose Claros Gonzalez - Ingeniería de Sistemas - CORHUILA
HERNANDO ANTONIO MARTIN HERRERA - Ingeniería de Sistemas - CORHUILA
